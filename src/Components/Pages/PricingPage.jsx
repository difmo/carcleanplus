...
const PricingPage = () => {
  ...
  return (
    <div className="bg-dark min-h-screen pt-32 pb-20 relative overflow-hidden font-sans">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="text-center mb-10 animate-fade-in">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 tracking-tight font-heading">
            Exclusive <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-light via-primary to-primary">Pricing Matrix</span>
          </h1>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-16 animate-fade-in relative" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="absolute inset-0 bg-primary/10 blur-xl rounded-full opacity-50 group-hover:opacity-100 transition-opacity duration-500"></div>

          <div className="relative group p-[1px] rounded-full bg-gradient-to-r from-primary-light/20 via-red-900/40 to-red-500/20 hover:from-primary-light/50 hover:via-red-500/30 hover:to-red-500/50 transition-all duration-500 shadow-[0_0_30px_rgba(0,82,204,0.7)] hover:shadow-[0_0_40px_rgba(0,82,204,0.7)] focus-within:shadow-[0_0_40px_rgba(0,82,204,0.7)] focus-within:from-primary-light/60 focus-within:to-red-500/60">
            <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none z-10">
              <FaSearch className="text-primary/70 text-xl group-focus-within:text-primary group-hover:scale-110 transition-all duration-300" />
            </div>
            <input
              type="text"
        ...
        <div className="bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(0,82,204,0.7)] animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gradient-to-r from-white/5 to-red-900/10 border-b border-primary-light/20 text-primary text-xs md:text-sm uppercase tracking-widest">
                  ...
                  <th className="px-6 py-5 font-bold text-center text-red-400 drop-shadow-[0_0_8px_rgba(0,82,204,0.7)]">Premium Wash (₹)</th>
                ...
                {filteredCars.map((car, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-center bg-primary-light/5 group-hover:bg-primary-light/10 transition-colors border-x border-primary-light/5 group-hover:border-primary-light/20">
                        <button
                          onClick={() => openModal(car, SERVICES.PREMIUM)}
                          className="w-full h-full py-2 px-3 rounded-lg hover:bg-primary-light/20 text-primary font-extrabold text-lg transition-all scale-100 hover:scale-110 drop-shadow-[0_0_5px_rgba(0,82,204,0.7)]"
                        >
                          {premiumPrice}
                        </button>
                      </td>
