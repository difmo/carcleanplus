  ...
  return (
    <> 
      <div>
        ...
        <div className="p-20">
          <div className="pl-5 font-medium"><h1 className="font-extrabold">Effective Date: July 01, 2024</h1></div>
          <div className="p-5">
          ...
          <div className="p-5 font-extrabold">Types of Information We May Collect from You</div>
          <div className="p-5">
          ...
          <div className="pl-5 pr-5 font-medium"><h1 className="font-extrabold">How We May Use the Information We Collect</h1></div>
          <div className="p-5">
          ...
          <div className="px-5 font-medium"><h1 className="font-extrabold">Disclosure of Your Information</h1></div>
          <div className="p-5">
          ...
          <div className="px-5 font-medium"><h1 className="font-extrabold">Your Rights – Access to Your Personal Data</h1></div>
          <div className="p-5">
          ...
          <div className="px-5 font-medium"><h1 className="font-extrabold">Changes to Our Privacy Policy</h1></div>
          <div className="p-5">
          ...
          <div className="px-5 font-medium"><h1 className="font-extrabold">Contact</h1></div>
          <div className="p-5">
          ...
          <div className="px-5 font-medium"><h1 className="font-extrabold">Effective Date</h1></div>
