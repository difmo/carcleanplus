    ...
    <>
      ...
      <div className="object-cover mx-4 md:mx-48 my-8 md:my-16 h-72 bg-[rgb(0,69,120)] rounded-3xl">
        ...
        Privacy Policy        </div>
          ...
          <div className="font-medium ">Effective Date: August 22, 2023</div>
          <div className="p-5">
            This Privacy Policy is prepared by LBIC Consulting Services, Inc.
            doing business as Agape Acts (“We”) and whose registered address is
            235 Wing Mill Road, Sandy Springs, GA, 30350, United States. We are
            committed to protecting and preserving the privacy of our visitors
            when visiting our site or communicating electronically with us. This
            policy sets out how we process any personal data we collect from you
            or that you provide to us through our website and social media
            sites. We confirm that we will keep your information secure and
            ...
            to us, or that we collect from you when you visit our sites. By
          ...
          <div className="p-5">
            ...
            social media sites: Information you supply to us. You may supply us
            with information about you by filling in forms on our website or
            social media. This includes information you provide when you submit
            a contact/inquiry form. The information you give us may include, but
            is not limited to, your name, address, e-mail address, and phone
            number.
          </div>
          <div className="p-5 font-medium">
            How we may use the information we collect
          </div>
          <div className="px-5">How we may use the information we collect</div>
          <div className="p-5">
          ...
          <div className="px-5m pl-5">
            ...
            Agape Acts, 235 Wing Mill Road Sandy Springs, GA, 30350. We will
            provide your personal data to you within the statutory time frames.
            To enable us to trace any of your personal data that we may be
            holding, we may need to request further information from you. If you
            complain about how we have used your information, you have the right
            to complain to the Information Commissioner’s Office (ICO). Changes
            to our privacy policy Any changes we may make to our privacy policy
            in the future will be posted on this page and, where appropriate,
            notified to you by e-mail. Please check back frequently to see any
            updates or changes to our privacy policy. Contact Questions,
            comments, and requests regarding this privacy policy are welcomed
            and should be addressed to: LBIC Consulting Services, Inc. doing
            business as Agape Acts, contact@agapeacts.com
          </div>
