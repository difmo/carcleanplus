      ...
      <div className="md:px-20 py-10 font-serif">
        <div className=" px-4 md:px-12">
          <h1 className=" font-sans  text-2xl">
            ...
            our services. Below is a comprehensive guide to help you navigate
            our offerings and get the support you need .
          </h1>
          <div className="font-bold py-2">Contact Us</div>
          <div>
            <h1 className="font-bold ">Phone Support:</h1>
            <p>
              For immediate assistance, call us at <span>[Phone No. +91 9939553453] </span>. Our
              customer service team is available [insert hours of operation].
            </p>
            <h1 className="font-bold ">Email Support:</h1>
            <p>
              You can reach us at <span>[Email Id. carcleanplus@gmail.com ]</span> for any inquiries or
              feedback. We aim to respond within [insert response time, e.g., 24
              hours].
            </p>
          </div>
          ...
          <div>
            ...
            <h1 className="font-bold ">How much water do you use for cleaning?</h1>
            <p>
            ...
            <h1 className="font-bold ">What if it rains after my car is cleaned?</h1>
            <p>
              While we strive to deliver the best results, external factors like
              weather can affect your vehicle’s cleanliness. We recommend
              parking under cover when possible.
            </p>
            <h1 className="font-bold ">Do you offer discounts for regular customers?</h1>
            <p>
              Yes, we have loyalty programs and discounts for repeat customers.
          ...
          <div>
            ...
            <p>
              ...
              notify us at least [insert time frame, e.g., 24 hours] in advance
          ...
          <div>
            <p>
              ...
              your experience with our services, please reach out to us via
              email or through our website’s feedback form.
            </p>
          </div>
        </div>
      </div>
