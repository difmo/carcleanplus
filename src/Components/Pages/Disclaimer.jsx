        ...
        <div className="h-auto ">
          ...
          <div className="h-auto px-4 md:px-36 py-4">
            ...
            <div className="py- px-2 ">
              ...
              Customers are encouraged to inspect their vehicle prior to
              cleaning and inform us of any areas that may require special
              attention.
            </div>
            ...
            <div className="py- px-2 ">
              If your vehicle has any custom modifications, non-standard
              finishes, or aftermarket accessories, please notify us in advance.
              We cannot be held liable for any damages to these modifications if
              they are not disclosed before service.
            </div>
            ...
            <div className="py- px-2 ">
              Our service prides itself on using only 20 liters of water per
              wash to minimize wastage. This approach is intended to be both
              effective and environmentally responsible. However, for extremely
              dirty vehicles, certain areas may not achieve the desired level of
              cleanliness, and additional services may be recommended.
            </div>
            <div className="text-2xl p-2">
              No Guarantee for External Factors:
            </div>
            <div className="py- px-2 ">
              ...
              dirt, grime, or water spots that may occur after the vehicle
              leaves our premises or once the cleaning is complete.
            </div>
            <div className="text-2xl p-2">Customer Responsibility:</div>
            <div className="py- px-2 ">
              Customers are responsible for securing all personal belongings,
              valuables, and loose items in the vehicle before cleaning. We do
              not accept liability for any lost or damaged items left inside the
