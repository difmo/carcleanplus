...
function Disclaimer() {
  return (
    ...
    <div className="h-auto">
      <div className="h-auto ">
        <div className="px-40 bg-[#004578] text-white">
          <div className="text-center py-16 text-5xl font-bold ">
            Disclaimer
          </div>
          <div className="px-60 text-center pb-10 text-xl ">
      ...
      <div className="px-3 justify-center flex"><img src={img} alt="" className="w-2/3 pr-20 py-10 "/></div>
