      ...
      <div className="container mx-auto px-4 z-10 pt-32 pb-32 lg:pb-48">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-12 animate-fade-in-up">
            <button
              onClick={openModal}
              className="group relative flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-bold py-4 px-10 rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_10px_40px_-10px_rgba(79,70,229,0.7)] border-b-4 border-indigo-900"
            >
