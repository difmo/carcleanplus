      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-sans font-bold text-white mb-2">
            See The Transformation<span className="text-primary">.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-8">
          {transformations.map((item, index) => (
            <div key={index} className="w-full flex gap-2 rounded-[24px] bg-[#0a0a0a] border border-white/10 shadow-lg p-2 transition-transform duration-300">
              {item.singleImage ? (
