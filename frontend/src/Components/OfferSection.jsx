      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <button
              onClick={() => openModal()}
              className="px-10 py-4 bg-gradient-to-r from-red-600 to-amber-500 text-white font-black rounded-full text-lg hover:-translate-y-1 transition-all duration-300"
            >
              Claim Offer Now - ₹899
            </button>
          </div>
          ...
          <div className="flex-1 w-full max-w-md mx-auto relative mt-10 md:mt-0">
            <div className="bg-white p-8 md:p-10 rounded-[40px] border-[4px] border-amber-100 relative transform hover:-translate-y-2 transition-transform duration-500 z-10">
               {/* Discount Badge */}
               <div className="absolute -top-6 -right-4 md:-right-8 w-24 h-24 bg-gradient-to-br from-red-500 to-rose-600 rounded-full flex flex-col items-center justify-center text-white font-black text-xl border-4 border-white rotate-12">
                 <span className="text-2xl leading-none">20%</span>
                 <span className="text-sm">OFF</span>
               </div>
               
               <div className="flex justify-center mb-6">
                 <div className="w-24 h-24 bg-gradient-to-br from-amber-100 to-orange-50 rounded-full flex items-center justify-center">
               ...
               <div className="space-y-4">
                 <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-5 rounded-2xl border border-amber-200 flex items-start gap-4">
                   <div className="bg-white p-3 rounded-xl text-amber-600 mt-1">
