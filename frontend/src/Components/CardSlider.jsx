...
const images = [
  {
    ...
    description:
      "Experience ultimate car care at INFINITY WASH, combining technology and eco-friendly practices for exceptional results that restore your vehicle’s beauty.",
  ...
  },
  {
    ...
    description:
      "Enjoy affordable, eco-friendly car cleaning at INFINITY WASH, where quality meets sustainability for a sparkling, responsible finish.",
    buttonText: "Discover More",
    image: car,
  },
  {
    ...
    description:
      "Choose INFINITY WASH for eco-friendly car care using minimal water and safe products to keep your vehicle spotless and valued.",
    buttonText: "Discover More",
    image: home1,
  },
];
